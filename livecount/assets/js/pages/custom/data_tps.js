...
var KTUserAdd = function () {
    ...
    var initDualListBox = function() {
        ...
        listBoxes.each(function() {
            var $this = $(this);
            var availableTitle = ($this.attr('data-available-title') != null) ? $this.attr('data-available-title') : 'KPPS List';
            var selectedTitle = ($this.attr('data-selected-title') != null) ? $this.attr('data-selected-title') : 'Selected KPPS';
