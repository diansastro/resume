...
var KTDatatableDataLocalDemo = function() {
    var demo = function() {
        ...
        var dataJSONArray = JSON.parse(
            '[{"recordId":1,"name":"Paslon 1","img":"","status":"Active","actions":null},\n' +
            '{"recordId":2,"name":"Paslon 2","img":"","status":"Inactive","actions":null},\n' +
            '{"recordId":3,"name":"Paslon 3","img":"","status":"Active","actions":null}]');

        var datatable = $('.candidate_local_data').KTDatatable({
            data: {
                // type: 'local',
                // source: {
                //     read: {
						...
						<div class="dropdown">\
							<a href="javascript:;" class="btn btn-sm btn-clean btn-icon btn-icon-md" data-toggle="dropdown">\
						  	...
						  	<div class="dropdown-menu dropdown-menu-right">\
						    	<a class="dropdown-item" href="create_candidate.html"><i class="la la-edit"></i>Edit / Lihat Detail</a>\
						  	</div>\
						</div>\
							...
							<div class="modal-dialog modal-dialog-centered" role="document">\
								<div class="modal-content">\
									<div class="modal-header">\
										<h5 class="modal-title" id="exampleModalLabel">Hapus Data Paslon</h5>\
